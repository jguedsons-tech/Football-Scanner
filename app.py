...
def main():
    ...
    with st.sidebar:
        ...
        days = st.selectbox("Dias para pesquisar (plano Free)", [1], index=0, help="O plano Free será consultado apenas para hoje e amanhã, evitando datas bloqueadas pela API.")
